...
{
  const rows = [
    ['Этап 1', 'Утверждение структуры', 'Согласованная карта сайта', '7 дн.', '374 000'],
    ['Этап 2', 'Разработка 3 концепций дизайна', '3 макета на выбор', '14 дн.', '747 000'],
    ['Этап 3', 'Утверждение контента и сценариев', 'Тексты, сценарии игр, путь повествования', '7 дн.', '374 000'],
    ['Этап 4', 'Правки дизайна', 'Не менее 5 итераций, итоговый макет', '14 дн.', '747 000'],
    ['Этап 5', 'Вёрстка', 'Mobile First + Desktop, все страницы', '21 дн.', '1 121 000'],
    ['Этап 6', 'Бэкенд и интеграции', 'Функционал, интеграция с «Поток»', '28 дн.', '1 495 000'],
    ['Этап 7', 'Игровые механики + ИИ-агент', 'Тесты, рекомендации, чат-бот', '21 дн.', '1 121 000'],
    ['Этап 8', 'Тестирование', 'Внутреннее, ИБ, финальное', '14 дн.', '747 000'],
    ['Этап 9', 'Запуск', 'Поэтапно: предприятия → полная версия', '7 дн.', '374 000'],
  ];
  slides.push(`
${slideOpen()}
  ${eyebrow('СТОИМОСТЬ')}
