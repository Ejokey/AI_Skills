...
${slideOpen()}
  ...
  <div class="cards cards-3" style="margin-top:22px">
    ${card('9 100 000 ₽', `<p class="p">Итого без НДС. Работы AIR НДС не облагаются (Сколково). Смета зафиксирована по каждому из 9 этапов.</p>`, { kicker: 'СТОИМОСТЬ', style: 'padding-top:14px' })}
...
{
  const rows = [
    ['Этап 1', 'Утверждение структуры', 'Согласованная карта сайта', '7 дн.', '479 000'],
    ['Этап 2', 'Разработка 3 концепций дизайна', '3 макета на выбор', '14 дн.', '958 000'],
    ['Этап 3', 'Утверждение контента и сценариев', 'Тексты, сценарии игр, путь повествования', '7 дн.', '479 000'],
    ['Этап 4', 'Правки дизайна', 'Не менее 5 итераций, итоговый макет', '14 дн.', '958 000'],
    ['Этап 5', 'Вёрстка', 'Mobile First + Desktop, все страницы', '21 дн.', '1 437 000'],
    ['Этап 6', 'Бэкенд и интеграции', 'Функционал, интеграция с «Поток»', '28 дн.', '1 916 000'],
    ['Этап 7', 'Игровые механики + ИИ-агент', 'Тесты, рекомендации, чат-бот', '21 дн.', '1 437 000'],
    ['Этап 8', 'Тестирование', 'Внутреннее, ИБ, финальное', '14 дн.', '958 000'],
    ['Этап 9', 'Запуск', 'Поэтапно: предприятия → полная версия', '7 дн.', '478 000'],
  ];
  slides.push(`
${slideOpen()}
  ${eyebrow('СТОИМОСТЬ')}
